...
const TRIP = {
  ...
  transport: [
    { leg: "8/18 機場 → Centum Premier", how: "✅ 已訂 Klook 接送，車程約 30-40 分" },
    { leg: "飯店 ↔ 옥된장／BEXCO／新世界百貨", how: "步行 5-10 分，Centum City 區內都用走的" },
    { leg: "Centum City → 초일육（海雲台）", how: "地鐵 2 號線 3 站到 Haeundae 站＋步行，約 20 分；趕時間計程車 10 分 ₩7,000 上下" },
    { leg: "8/20 送行李 Centum → MS 飯店", how: "計程車 15 分 ₩8,000-10,000（拖行李別搭地鐵）" },
    { leg: "Centum City → 嚴湧帛（水營）", how: "地鐵 2 號線 2 站到 Suyeong 站＋步行 10 分" },
    { leg: "嚴湧帛 → SEA LIFE", how: "計程車 10 分 ₩7,000-9,000 最順" },
    { leg: "SEA LIFE → MS 飯店", how: "沿海雲台海灘步行 10-15 分，順便看海 🌊" },
    { leg: "8/23 MS 飯店 → 金海機場", how: "計程車 40-60 分 ₩35,000 上下；省錢備案：地鐵 2 號線→沙上站轉輕軌約 85 分 ₩3,000/人。⚠️ 最晚 17:00 出發！" },
    { leg: "💳 通用", how: "機場便利商店買 T-money 交通卡（各儲 ₩20,000）；計程車用 Kakao T App 叫；路線以 Naver Map 即時查詢為準" },
  ],
